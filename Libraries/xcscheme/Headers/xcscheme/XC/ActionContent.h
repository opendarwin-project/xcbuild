...
class ActionContent {
    ...
    public:
	inline std::string const &scriptText() const { return _scriptText; }

    public:
	inline BuildableReference::shared_ptr const &
	environmentBuildable() const
	{
	...
	inline std::string const &emailSubject() const { return _emailSubject; }
	inline std::string const &emailBody() const { return _emailBody; }
	inline bool attachLogToEmail() const { return _attachLogToEmail; }
