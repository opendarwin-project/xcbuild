...
class LaunchAction : public Action {
    ...
    public:
	inline uint32_t launchStyle() const { return _launchStyle; }
	...
	buildableProductRunnable() const
	{
    ...
    public:
	inline LocationScenarioReference::shared_ptr const &
	locationScenarioReference() const
	{
		return _locationSecenarioReference;
	}
	inline LocationScenarioReference::shared_ptr &
