...
class Scheme {
    ...
    public:
	inline bool shared() const { return _owner.empty(); }
    ...
    public:
	inline std::string const &owner() const { return _owner; }
	...
	inline BuildAction::shared_ptr &buildAction() { return _buildAction; }
	...
	inline TestAction::shared_ptr &testAction() { return _testAction; }
    ...
    public:
	static shared_ptr Open(libutil::Filesystem const *filesystem,
	    std::string const &name, std::string const &owner,
