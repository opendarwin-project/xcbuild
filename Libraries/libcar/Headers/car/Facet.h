...
class Facet {
	 ...
	 */
	void renditionIterate(Reader const *archive,
	 ...
	 */
	static Facet Load(
	    std::string const &name, struct car_facet_value const *value);

	/*
	 * Create a facet with the provided name and attributes
	 */
	static Facet Create(
	    std::string const &name, AttributeList const &attributes);
};
