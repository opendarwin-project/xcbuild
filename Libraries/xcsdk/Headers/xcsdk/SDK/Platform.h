...
class Platform {
	...
	inline ext::optional<std::string> const &icon() const { return _icon; }
	inline ext::optional<std::string> const &type() const { return _type; }
	...
	runtimeSystemSpecification() const
	{
    ...
    public:
	static Platform::shared_ptr Open(libutil::Filesystem const *filesystem,
