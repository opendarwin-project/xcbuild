...
class Target {
    ...
    public:
	inline Product::shared_ptr const &product() const { return _product; }
	...
	inline std::string const &bundleName() const { return _bundleName; }
    ...
    public:
	inline bool isBaseSDK() const { return _isBaseSDK.value_or(false); }
	...
	inline ext::optional<std::vector<std::string>> &
    ...
    public:
	static Target::shared_ptr Open(libutil::Filesystem const *filesystem,
	    std::shared_ptr<Manager> manager, std::shared_ptr<Platform>,
