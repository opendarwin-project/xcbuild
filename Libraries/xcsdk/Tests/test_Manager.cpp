...
TEST(Manager, ConfigurationExtraPaths)
{
	...
	auto configuration = Configuration(
	    { filesystem.path("ExtraPlatforms") },
	    { filesystem.path("ExtraToolchains") });
	auto manager = Manager::Open(
	    &filesystem, filesystem.path(""), configuration);
