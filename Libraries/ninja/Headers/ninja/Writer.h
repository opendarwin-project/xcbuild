...
class Writer {
	 ...
	 */
	void command(std::string const &command, std::string const &remaining,
	 ...
	 */
	void rule(std::string const &name, Value const &command,
	    std::vector<Binding> const &bindings = { });

	/*
	 * Build a file with the specified rule, using the inputs and
	 * dependencies.
	 */
	void build(std::vector<Value> const &outputs, std::string const &rule,
	    std::vector<Value> const &inputs,
	    std::vector<Binding> const &bindings = { },
	    std::vector<Value> const &dependencies = { },
	    std::vector<Value> const &orders = { });
