...
BuildSettings::shared_ptr BuildSettings::Parse(
...
bool BuildSettings::parse(Context *context, plist::Dictionary const *dict,
...
bool BuildSettings::inherit(Specification::shared_ptr const &base)
{
...
bool BuildSettings::inherit(BuildSettings::shared_ptr const &b)
{
	...
	_options = Inherit::Combine(
	    _options, base->options(), &_optionsUsed, &base->_optionsUsed);
