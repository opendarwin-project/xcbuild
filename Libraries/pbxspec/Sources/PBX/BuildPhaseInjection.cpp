...
BuildPhaseInjection::BuildPhaseInjection() { }

bool BuildPhaseInjection::parse(plist::Dictionary const *dict)
{
	...
	auto ROFDP = unpack.coerce<plist::Boolean>(
	    "RunOnlyForDeploymentPostprocessing");
	auto NRSPFF = unpack.coerce<plist::Boolean>(
	    "NeedsRunpathSearchPathForFrameworks");
