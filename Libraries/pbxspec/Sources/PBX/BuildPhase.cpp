...
BuildPhase::shared_ptr BuildPhase::Parse(
...
bool BuildPhase::parse(Context *context, plist::Dictionary const *dict,
...
bool BuildPhase::inherit(Specification::shared_ptr const &base)
{
...
bool BuildPhase::inherit(BuildPhase::shared_ptr const &b)
{
