...
class Tool : public Specification {
	...
	ext::optional<std::unordered_map<std::string, pbxsetting::Value>>
    ...
    public:
	inline SpecificationType type() const override { return Tool::Type(); }
	...
	execDescriptionForPrecompile() const
	{
		return _execDescriptionForPrecompile;
	}
	inline ext::optional<pbxsetting::Value> const &
	execDescriptionForCompile() const
	{
		return _execDescriptionForCompile;
	}
	inline ext::optional<pbxsetting::Value> const &
	execDescriptionForCreateBitcode() const
	{
	...
	inline ext::optional<pbxsetting::Value> const &
	progressDescriptionForPrecompile() const
	{
		return _progressDescriptionForPrecompile;
	}
	inline ext::optional<pbxsetting::Value> const &
	progressDescriptionForCompile() const
	{
		return _progressDescriptionForCompile;
	}
	inline ext::optional<pbxsetting::Value> const &
	progressDescriptionForCreateBitcode() const
	{
    ...
    public:
	inline ext::optional<
	    std::unordered_map<std::string, pbxsetting::Value>> const &
    ...
    public:
	inline bool isAbstract() const { return _isAbstract.value_or(false); }
	...
	caresAboutInclusionDependenciesOptional() const
	{
    ...
    public:
	inline ext::optional<int> messageLimit() const { return _messageLimit; }
    ...
    public:
	inline ext::optional<std::unordered_set<std::string>> const &
	deletedProperties() const
	{
