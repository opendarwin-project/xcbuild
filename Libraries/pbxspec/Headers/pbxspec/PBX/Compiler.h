...
class Compiler : public Tool {
	...
	ext::optional<std::vector<std::string>>
	...
	ext::optional<std::vector<pbxsetting::Value>>
	...
	commandResultsPostprocessor() const
	{
    ...
    public:
	inline ext::optional<std::string> const &
	genericCommandFailedErrorString() const
	{
		return _genericCommandFailedErrorString;
	}

    public:
	inline ext::optional<pbxsetting::Value> const &
	generatedInfoPlistContentFilePath() const
	{
    ...
    public:
	inline ext::optional<pbxsetting::Value> const &
	dependencyInfoFile() const
	{
		return _dependencyInfoFile;
	}
	inline ext::optional<std::vector<pbxsetting::Value>> const &
	dependencyInfoArgs() const
	{
    ...
    public:
	inline ext::optional<std::vector<std::string>> const &
	patternsOfFlagsNotAffectingPrecomps() const
	{
    ...
    public:
	inline ext::optional<std::vector<std::string>> const &
	messageCategoryInfoOptions() const
	{
    ...
    public:
	inline ext::optional<std::vector<std::string>> const &
	synthesizeBuildRuleForBuildPhases() const
	{
    ...
    public:
	inline ext::optional<std::vector<pbxsetting::Value>> const &
	additionalDirectoriesToCreate() const
	{
	...
	{
		return _useCPlusPlusCompilerDriverWhenBundlizing.value_or(
		    false);
	}
	inline ext::optional<bool>
	useCPlusPlusCompilerDriverWhenBundlizingOptional() const
	{
	...
	inline ext::optional<bool>
	supportsSeparateUserHeaderPathsOptional() const
	{
	...
	inline ext::optional<bool>
	supportsGeneratePreprocessedFileOptional() const
	{
	...
	inline ext::optional<bool>
	supportsMacOSXDeploymentTargetOptional() const
	{
    ...
    public:
	inline bool softError() const { return _softError.value_or(false); }
    ...
    protected:
	static Compiler::shared_ptr Parse(
