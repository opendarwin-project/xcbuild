...
class ProductType : public Specification {
	...
	class Validation {
		...
		class Check {
			...
			Check(ext::optional<std::string> const &check,
			...
			inline ext::optional<std::string> const &
			description() const
			{
				return _description;
			}
	...
	ext::optional<std::vector<BuildPhaseInjection>>
	...
	ext::optional<std::unordered_map<std::string, std::vector<std::string>>>
	    _allowedFileTypes;
	ext::optional<
	    std::unordered_map<std::string, std::vector<FileReference>>>
	    _buildPhaseFileRefAdditions;
	...
	{
		return std::static_pointer_cast<ProductType>(
		    Specification::base());
	}
    ...
    public:
	inline ext::optional<pbxsetting::Level> const &
	defaultBuildProperties() const
	{
    ...
    public:
	inline ext::optional<std::vector<std::string>> const &
	packageTypes() const
	{
    ...
    public:
	inline bool isWrapper() const { return _isWrapper.value_or(false); }
    ...
    public:
	inline bool isJava() const { return _isJava.value_or(false); }
	inline ext::optional<bool> isJavaOptional() const { return _isJava; }
	...
	{
		return _wantsSimpleTargetEditingWithoutCapabilities.value_or(
		    false);
	}
	inline ext::optional<bool>
	wantsSimpleTargetEditingWithoutCapabilitiesOptional() const
	{
    ...
    public:
	inline bool runsOnProxy() const { return _runsOnProxy.value_or(false); }
	...
	inline ext::optional<bool>
	canEmbedAddressSanitizerLibrariesOptional() const
	{
	...
	inline ext::optional<bool>
	canEmbedCompilerSanitizerLibrariesOptional() const
	{
    ...
    public:
	inline ext::optional<std::string> const &
	runpathSearchPathForEmbeddedFrameworks() const
	{
	...
	inline ext::optional<std::vector<BuildPhaseInjection>> const &
	buildPhaseInjectionsWhenEmbedding() const
	{
		return _buildPhaseInjectionsWhenEmbedding;
	}
	inline ext::optional<std::string> const &
	requiredBuiltProductsDir() const
	{
		return _requiredBuiltProductsDir;
	}
	inline ext::optional<std::vector<std::string>> const &
	allowedBuildPhases() const
	{
    ...
    public:
	inline ext::optional<
	    std::unordered_map<std::string, std::vector<FileReference>>> const &
	buildPhaseFileRefAdditions() const
	{
		return _buildPhaseFileRefAdditions;
	}
	inline ext::optional<pbxsetting::Level> const &
	infoPlistAdditions() const
	{
    ...
    protected:
	static ProductType::shared_ptr Parse(
