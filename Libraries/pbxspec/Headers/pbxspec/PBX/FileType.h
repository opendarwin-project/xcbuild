...
class FileType : public Specification {
	...
	{
		return std::static_pointer_cast<FileType>(
		    Specification::base());
	}

    public:
	inline ext::optional<std::string> const &UTI() const { return _uti; }
	...
	inline ext::optional<std::vector<std::string>> const &
	filenamePatterns() const
	{
		return _filenamePatterns;
	}
	inline ext::optional<std::vector<std::vector<uint8_t>>> const &
	magicWords() const
	{
		return _magicWords;
	}
	...
	plistStructureDefinition() const
	{
		return _plistStructureDefinition;
	}

    public:
	inline bool isTextFile() const { return _isTextFile.value_or(false); }
    ...
    public:
	inline bool isBundle() const { return _isBundle.value_or(false); }
    ...
    public:
	inline bool isLibrary() const { return _isLibrary.value_or(false); }
    ...
    public:
	inline bool isFolder() const { return _isFolder.value_or(false); }
    ...
    public:
	inline ext::optional<std::vector<std::string>> const &
	extraPropertyNames() const
	{
		return _extraPropertyNames;
	}
	inline ext::optional<std::vector<ComponentPart>> const &
	componentParts() const
	{
	...
	changesCauseDependencyGraphInvalidationOptional() const
	{
		return _changesCauseDependencyGraphInvalidation;
	}
	inline ext::optional<std::string> const &
	fallbackAutoroutingBuildPhase() const
	{
    ...
    protected:
	static FileType::shared_ptr Parse(
