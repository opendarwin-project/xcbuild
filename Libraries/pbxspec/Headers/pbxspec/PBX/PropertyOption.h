...
class PropertyOption {
	...
	static void Insert(
	    vector *options, used_map *used, shared_ptr const &option)
	{
    ...
    public:
	inline std::string const &type() const { return _type; }
    ...
    public:
	inline bool basic() const { return _basic.value_or(false); }
	inline ext::optional<bool> basicOptional() const { return _basic; }
	...
	inline plist::Object const *values() const { return _values; }
	...
	commandLineFlagIfFalse() const
	{
		return _commandLineFlagIfFalse;
	}
	inline ext::optional<pbxsetting::Value> const &
	commandLinePrefixFlag() const
	{
	...
	flattenRecursiveSearchPathsInValueOptional() const
	{
    ...
    public:
	inline ext::optional<pbxsetting::Value> const &
	setValueInEnvironmentVariable() const
	{
