 ...
 */
template <class Traits> class BaseAbsolute {
    private:
	 ...
	 */
	std::string const &raw() const { return _inner.raw(); }

	/*
	 * The inner relative path.
	 */
	BaseRelative<Traits> const &relative() const { return _inner; }

    public:
	/*
	 * The normalized path string.
	 */
	std::string normalized() const { return _inner.normalized(); }

    public:
	/*
	 * Relative path to this absolute path from another path.
	 */
	ext::optional<BaseRelative<Traits>> from(
	    BaseAbsolute<Traits> const &from) const;
	 ...
	 */
	std::string extension() const { return _inner.extension(); }
	 ...
	 */
	static ext::optional<BaseAbsolute<Traits>> Create(
