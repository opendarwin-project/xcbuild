...
TEST(FSUtil, GetBaseNameWithoutExtension)
{
	...
	EXPECT_EQ(
	    "c.sub", FSUtil::GetBaseNameWithoutExtension("/a/b/c.sub.ext"));
}
...
{
	EXPECT_VECTOR_EQ(
	    { "/", "a", "b" }, FSUtil::NormalizePathComponents("/a/b"));
	EXPECT_VECTOR_EQ({ "a", "b" }, FSUtil::NormalizePathComponents("a/b"));
	EXPECT_VECTOR_EQ(
	    { "/", "a", "b" }, FSUtil::NormalizePathComponents("/a/./b"));
	EXPECT_VECTOR_EQ(
	    { "/", "b" }, FSUtil::NormalizePathComponents("/a/../b"));
	EXPECT_VECTOR_EQ({ ".." }, FSUtil::NormalizePathComponents("a/../.."));
	EXPECT_VECTOR_EQ({ "/" }, FSUtil::NormalizePathComponents("/a/../.."));
	EXPECT_VECTOR_EQ({ "..", "..", ".." },
	    FSUtil::NormalizePathComponents("a/../../../.."));
