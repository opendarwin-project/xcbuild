...
class FileReference : public GroupItem {
    ...
    public:
	inline bool includeInIndex() const { return _includeInIndex; }

    public:
	inline FileEncoding fileEncoding() const { return _fileEncoding; }
	inline LineEnding lineEnding() const { return _lineEnding; }
    ...
    public:
	static inline char const *Isa() { return ISA::PBXFileReference; }
};
