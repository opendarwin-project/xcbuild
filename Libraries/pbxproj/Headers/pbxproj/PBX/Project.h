...
class Project : public Object {
    ...
    public:
	inline XC::ConfigurationList::shared_ptr const &
	buildConfigurationList() const
	{
    ...
    public:
	inline Group::shared_ptr const &mainGroup() const { return _mainGroup; }
	...
	inline std::string const &projectRoot() const { return _projectRoot; }
    ...
    public:
	inline Target::vector const &targets() const { return _targets; }

    public:
	inline std::string const &name() const { return _name; }
	inline std::string const &dataFile() const { return _dataFile; }
	inline std::string const &projectFile() const { return _projectFile; }
    ...
    public:
	inline Object::shared_ptr resolveBuildableReference(
	    std::string const &blueprintIdentifier) const
	{
    ...
    public:
	static inline char const *Isa() { return ISA::PBXProject; }
};
