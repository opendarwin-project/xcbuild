...
class ShellScriptBuildPhase : public BuildPhase {
    ...
    public:
	inline std::string const &shellPath() const { return _shellPath; }
	inline std::string const &shellScript() const { return _shellScript; }
    ...
    public:
	inline bool showEnvVarsInLog() const { return _showEnvVarsInLog; }
