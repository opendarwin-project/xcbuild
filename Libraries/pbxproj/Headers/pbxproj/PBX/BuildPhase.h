...
class BuildPhase : public Object {
    ...
    public:
	inline BuildFile::vector const &files() const { return _files; }
	inline BuildFile::vector &files() { return _files; }
    ...
    public:
	inline uint32_t buildActionMask() const { return _buildActionMask; }
