...
class BuildRule : public Object {
    ...
    public:
	inline std::string const &compilerSpec() const { return _compilerSpec; }

    public:
	inline std::string const &filePatterns() const { return _filePatterns; }

	inline std::string const &fileType() const { return _fileType; }

    public:
	inline std::string const &script() const { return _script; }
    ...
    public:
	inline bool isEditable() const { return _isEditable; }
    ...
    public:
	static inline char const *Isa() { return ISA::PBXBuildRule; }
};
