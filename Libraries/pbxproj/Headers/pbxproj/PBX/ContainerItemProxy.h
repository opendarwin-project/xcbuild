...
class ContainerItemProxy : public Object {
    ...
    public:
	inline uint32_t proxyType() const { return _proxyType; }
	...
	inline std::string const &remoteInfo() const { return _remoteInfo; }
    ...
    public:
	static inline char const *Isa() { return ISA::PBXContainerItemProxy; }
};
