    ...
    std::vector<std::string>::const_iterator *it)
{
	...
	if (arg == "--version") {
		...
		return libutil::Options::Next<std::string>(
		    &_compileOutputFilename, args, it);
	} else if (arg == "--output-format") {
		return libutil::Options::Next<std::string>(
		    &_outputFormat, args, it);
		...
		return libutil::Options::Next<std::string>(
		    &_productType, args, it);
	} else if (arg == "--export-dependency-info") {
		return libutil::Options::Next<std::string>(
		    &_exportDependencyInfo, args, it);
	} else if (arg == "--optimization") {
		return libutil::Options::Next<std::string>(
		    &_optimization, args, it);
...
bool Options::isValid(Result *result) const
{
