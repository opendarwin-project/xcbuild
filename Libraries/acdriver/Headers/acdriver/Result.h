...
class Result {
    ...
    private:
	std::unordered_map<std::string, std::vector<NormalEntry>>
	    _normalEntries;
	std::unordered_map<std::string, std::vector<DocumentEntry>>
	    _documentEntries;
	 ...
	 */
	void normal(Severity severity, std::string const &message,
	 ...
	 */
	void document(Severity severity, std::string const &catalog,
    ...
    private:
	static std::unique_ptr<plist::Object> NormalEntryValue(
	    NormalEntry const &entry);
	static std::string NormalEntryText(NormalEntry const &entry);
	static std::unique_ptr<plist::Object> DocumentEntryValue(
