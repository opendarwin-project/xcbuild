...
class Output {
	 ...
	 */
	ext::optional<std::string> const &appIcon() { return _appIcon; }

	/*
	 * The name of the launch image to use.
	 */
	ext::optional<std::string> const &launchImage() { return _launchImage; }
	 ...
	 */
	ext::optional<car::Writer> const &car() const { return _car; }
	ext::optional<car::Writer> &car() { return _car; }
	...
	plist::Dictionary *additionalInfo() { return _additionalInfo.get(); }
