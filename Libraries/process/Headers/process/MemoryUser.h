...
class MemoryUser : public User {
    ...
    public:
	MemoryUser(std::string const &userID, std::string const &groupID,
	    std::string const &userName, std::string const &groupName);
	explicit MemoryUser(User const *user);
	virtual ~MemoryUser();

    public:
	virtual std::string const &userID() const { return _userID; }
	std::string &userID() { return _userID; }

	virtual std::string const &groupID() const { return _groupID; }
	std::string &groupID() { return _groupID; }

	virtual std::string const &userName() const { return _userName; }
	std::string &userName() { return _userName; }

	virtual std::string const &groupName() const { return _groupName; }
