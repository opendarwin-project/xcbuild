...
int HelpAction::Run(process::Context const *processContext)
{
	...
	fprintf(stdout,
	    "    -generate                                   "
	    "specify that an execution engine based on generating another "
	    "build "
	...
	fprintf(stdout,
	    ...
	    "any settings already specified elsewhere, such as the project "
	    "file\n");
	fprintf(stdout,
	    "    -arch ARCH                                  "
	    "instead of building the architectures defined in the project, "
	    "build "
	...
	fprintf(stdout,
	    ...
	    "print the path to executable NAME in the provided SDK and "
	    "toolchain\n");
	fprintf(stdout,
	    "    -find-library NAME                          "
	    "not yet implemented\n");
