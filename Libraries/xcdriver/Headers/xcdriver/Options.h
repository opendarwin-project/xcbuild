...
class Options {
	...
	std::vector<std::string> const &target() const { return _target; }
	bool allTargets() const { return _allTargets.value_or(false); }
	ext::optional<std::string> const &workspace() const
	{
		return _workspace;
	}
	ext::optional<std::string> const &scheme() const { return _scheme; }
	...
	/* Extension. */
	ext::optional<std::string> const &executor() const { return _executor; }
	/* Extension. */
	bool generate() const { return _generate.value_or(false); }
	...
	ext::optional<int> jobs() const { return _jobs; }
	bool dryRun() const { return _dryRun.value_or(false); }
	...
	bool showSDKs() const { return _showSDKs.value_or(false); }
    ...
    public:
	ext::optional<std::string> const &xcconfig() const { return _xcconfig; }
    ...
    public:
	bool exportArchive() const { return _exportArchive.value_or(false); }
	...
	std::vector<std::string> const &actions() const { return _actions; }
	...
	bool forceImport() const { return _forceImport.value_or(false); }
