...
class Insets {
    ...
    public:
	ext::optional<double> const &top() const { return _top; }
	ext::optional<double> const &left() const { return _left; }
	ext::optional<double> const &bottom() const { return _bottom; }
	ext::optional<double> const &right() const { return _right; }
