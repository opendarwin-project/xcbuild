...
class LaunchImage : public Asset {
	...
	class Image {
		...
		ext::optional<Slot::SystemVersion> const &
		minimumSystemVersion() const
		{
    ...
    public:
	static AssetType Type() { return AssetType::LaunchImage; }
	virtual AssetType type() const { return AssetType::LaunchImage; }
