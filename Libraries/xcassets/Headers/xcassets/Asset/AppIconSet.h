...
class AppIconSet : public Asset {
    ...
    public:
	bool preRendered() const { return _preRendered.value_or(false); }
    ...
    public:
	static AssetType Type() { return AssetType::AppIconSet; }
	virtual AssetType type() const { return AssetType::AppIconSet; }
