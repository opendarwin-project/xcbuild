...
class DataSet : public Asset {
	...
	ext::optional<std::vector<Data>> const &data() const { return _data; }

    public:
	static AssetType Type() { return AssetType::DataSet; }
	virtual AssetType type() const { return AssetType::DataSet; }
