...
class CubeTextureSet : public Asset {
	...
	ext::optional<TextureOrigin> const &origin() const { return _origin; }
    ...
    public:
	static AssetType Type() { return AssetType::CubeTextureSet; }
	virtual AssetType type() const { return AssetType::CubeTextureSet; }
