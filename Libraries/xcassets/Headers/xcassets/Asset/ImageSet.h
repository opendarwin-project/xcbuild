...
class ImageSet : public Asset {
	...
	class Image {
		...
		bool unassigned() const { return _unassigned.value_or(false); }
		...
		ext::optional<Slot::GraphicsFeatureSet> const &
		graphicsFeatureSet() const
		{
	...
	ext::optional<TemplateRenderingIntent> const &
	templateRenderingIntent() const
	{
		return _templateRenderingIntent;
	}

    public:
	static AssetType Type() { return AssetType::ImageSet; }
	virtual AssetType type() const { return AssetType::ImageSet; }
