...
class StickerSequence : public Asset {
	...
	ext::optional<double> const &duration() const { return _duration; }
    ...
    public:
	static AssetType Type() { return AssetType::StickerSequence; }
	virtual AssetType type() const { return AssetType::StickerSequence; }
