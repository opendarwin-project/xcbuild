...
FullyQualifiedName::FullyQualifiedName(
    std::vector<std::string> const &groups, std::string const &name)
    : _groups(groups)
    , _name(name)
{
}

std::string FullyQualifiedName::string() const
{
	std::string string;
...
FullyQualifiedName FullyQualifiedName::Parse(std::string const &string)
{
	/* Split on slashes. */
