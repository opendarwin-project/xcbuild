...
bool LaunchImage::Image::parse(plist::Dictionary const *dict)
{
	...
	if (MSV != nullptr) {
		_minimumSystemVersion = Slot::SystemVersion::Parse(
		    MSV->value());
	}
...
bool LaunchImage::parse(plist::Dictionary const *dict,
