...
bool ComplicationSet::ComplicationAsset::parse(plist::Dictionary const *dict)
{
	std::unordered_set<std::string> seen;
	auto unpack = plist::Keys::Unpack(
	    "ComplicationSetComplicationAsset", dict, &seen);
...
bool ComplicationSet::parse(plist::Dictionary const *dict,
