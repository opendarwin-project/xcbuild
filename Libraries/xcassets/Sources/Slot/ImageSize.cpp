...
ImageSize::ImageSize(double width, double height)
    : _width(width)
    , _height(height)
{
}

ext::optional<ImageSize> ImageSize::Parse(std::string const &value)
{
	/* Must not be empty */
	if (value.empty()) {
...
std::string ImageSize::String(ImageSize imageSize)
{
