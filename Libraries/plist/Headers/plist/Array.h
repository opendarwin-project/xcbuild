...
class Array : public Object {
	...
	inline Object *value(size_t index) { return _array[index].get(); }
    ...
    public:
	virtual ObjectType type() const { return Array::Type(); }

	static inline ObjectType Type() { return ObjectType::Array; }
