...
class Integer : public Object {
	...
	inline void setValue(int64_t value) { _value = value; }
    ...
    public:
	virtual ObjectType type() const { return Integer::Type(); }

	static inline ObjectType Type() { return ObjectType::Integer; }
