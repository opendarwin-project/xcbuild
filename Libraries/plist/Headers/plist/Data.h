...
class Data : public Object {
	...
	Data(void const *bytes, size_t length) { setValue(bytes, length); }

    public:
	inline std::vector<uint8_t> const &value() const { return _value; }
    ...
    public:
	static std::unique_ptr<Data> New(
    ...
    public:
	virtual ObjectType type() const { return Data::Type(); }

	static inline ObjectType Type() { return ObjectType::Data; }
