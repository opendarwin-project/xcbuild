...
class String : public Object {
	...
	inline void setValue(std::string const &value) { _value = value; }

	inline void setValue(std::string &&value) { _value = std::move(value); }

    public:
	static std::unique_ptr<String> New(
    ...
    public:
	virtual ObjectType type() const { return String::Type(); }

	static inline ObjectType Type() { return ObjectType::String; }
