...
class Date : public Object {
    ...
    public:
	inline struct tm const &value() const { return _value; }

	inline void setValue(struct tm const &value) { _value = value; }
    ...
    public:
	virtual ObjectType type() const { return Date::Type(); }

	static inline ObjectType Type() { return ObjectType::Date; }
	...
	{
		return (obj != nullptr &&
		    (obj == this || unixTimeValue() == obj->unixTimeValue()));
	}
};
