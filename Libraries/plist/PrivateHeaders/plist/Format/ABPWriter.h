...
class ABPWriter : public ABPContext {
	...
	std::unordered_map<plist::Object const *, plist::Object const *>
	    _mappings;
	std::unordered_set<plist::Object const *> _written;
	std::unordered_map<plist::Dictionary const *,
	    std::unordered_map<int, plist::String *>>
	    _keyStrings;
	...
	plist::String const *dictionaryKeyString(
	    plist::Dictionary const *dict, int key);
    ...
    private:
	bool processObject(
	    plist::Object const **object, uint32_t *refno, bool userProcess);
};
