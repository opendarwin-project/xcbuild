...
std::unique_ptr<Boolean> Boolean::New(bool value)
{
	return std::unique_ptr<Boolean>(new Boolean(value));
}

bool Boolean::equals(Object const *obj) const
{
