...
std::unique_ptr<String> String::New(std::string const &value)
{
	return std::unique_ptr<String>(new String(value));
}

std::unique_ptr<String> String::New(std::string &&value)
{
	return std::unique_ptr<String>(new String(std::move(value)));
}

std::unique_ptr<Object> String::_copy() const
{
	return plist::static_unique_pointer_cast<Object>(String::New(value()));
}

std::unique_ptr<String> String::Coerce(Object const *obj)
{
