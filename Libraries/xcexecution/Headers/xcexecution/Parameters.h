...
class Parameters {
	 ...
	 * Build all targets.
	 */
	bool allTargets() const { return _allTargets; }
	...
	ext::optional<pbxbuild::WorkspaceContext> loadWorkspace(
	    libutil::Filesystem const *filesystem, std::string const &userName,
