...
{
	EXPECT_EQ(
	    Type::ParseList("hello"), std::vector<std::string>({ "hello" }));
	EXPECT_EQ(Type::ParseList("hello world"),
	...
	EXPECT_EQ(Type::ParseList("\"hello\" \"world\""),
	    std::vector<std::string>({ "hello", "world" }));
	EXPECT_EQ(Type::ParseList("'hello wo'rld"),
	    std::vector<std::string>({ "hello world" }));
	EXPECT_EQ(Type::ParseList("hell'o wo'rld"),
	    std::vector<std::string>({ "hello world" }));
	EXPECT_EQ(Type::ParseList("'' '' 'test'"),
