...
TEST(Value, Simple)
{
	...
	ASSERT_EQ(
	    explicit_string.entries().at(0).type(), Value::Entry::Type::String);
	...
	ASSERT_EQ(explicit_variable.entries().at(0).type(),
	    Value::Entry::Type::Value);
	ASSERT_EQ(
	    explicit_variable.entries().at(0).value()->entries().size(), 1);
	ASSERT_EQ(
	    explicit_variable.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*explicit_variable.entries()
		      .at(0)
		      .value()
		      ->entries()
		      .at(0)
	...
	ASSERT_EQ(variable1.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*variable1.entries().at(0).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(variable2.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*variable2.entries().at(0).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(variable3.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*variable3.entries().at(0).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(nested1.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::Value);
	EXPECT_EQ(nested1.entries()
		      .at(0)
		      .value()
		      ->entries()
		      .at(0)
	...
	ASSERT_EQ(partial2.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*partial2.entries().at(0).value()->entries().at(0).string(),
	    "(open");
...
TEST(Value, Complex)
{
	...
	ASSERT_EQ(mixed1.entries().at(1).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*mixed1.entries().at(1).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(mixed2.entries().at(1).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*mixed2.entries().at(1).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(mixed3.entries().at(1).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*mixed3.entries().at(1).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(mixed3.entries().at(3).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*mixed3.entries().at(3).value()->entries().at(0).string(),
	    "VARIABLE");
	...
	ASSERT_EQ(nested1.entries().at(1).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(
	    *nested1.entries().at(1).value()->entries().at(0).string(), "TWO_");
	ASSERT_EQ(nested1.entries().at(1).value()->entries().at(1).type(),
	    Value::Entry::Type::Value);
	EXPECT_EQ(nested1.entries()
		      .at(1)
		      .value()
	...
	Value nested2 = Value::Parse(
	    "ONE_$(TWO_${THREE}_FOUR_$(FIVE)_SIX)_SEVEN");
	...
	ASSERT_EQ(nested2.entries().at(1).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(
	    *nested2.entries().at(1).value()->entries().at(0).string(), "TWO_");
	ASSERT_EQ(nested2.entries().at(1).value()->entries().at(1).type(),
	    Value::Entry::Type::Value);
	EXPECT_EQ(nested2.entries()
		      .at(1)
		      .value()
		      ->entries()
		      .at(1)
	...
	ASSERT_EQ(*nested2.entries()
		      ...
		      .string(),
	    "THREE");
	ASSERT_EQ(nested2.entries().at(1).value()->entries().at(2).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*nested2.entries().at(1).value()->entries().at(2).string(),
	    "_FOUR_");
	ASSERT_EQ(nested2.entries().at(1).value()->entries().at(3).type(),
	    Value::Entry::Type::Value);
	EXPECT_EQ(nested2.entries()
		      .at(1)
		      .value()
	...
	ASSERT_EQ(*nested2.entries()
		      ...
		      .string(),
	    "FIVE");
	ASSERT_EQ(nested2.entries().at(1).value()->entries().at(4).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(
	    *nested2.entries().at(1).value()->entries().at(4).string(), "_SIX");
...
TEST(Value, Add)
{
	...
	ASSERT_EQ(
	    empty_string.entries().at(0).type(), Value::Entry::Type::String);
	...
	ASSERT_EQ(
	    empty_variable.entries().at(0).type(), Value::Entry::Type::Value);
	ASSERT_EQ(empty_variable.entries().at(0).value()->entries().size(), 1);
	ASSERT_EQ(
	    empty_variable.entries().at(0).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(
	    *empty_variable.entries().at(0).value()->entries().at(0).string(),
	    "VARIABLE");

	Value string_variable = string + variable;
	ASSERT_EQ(string_variable.entries().size(), 2);
	ASSERT_EQ(
	    string_variable.entries().at(0).type(), Value::Entry::Type::String);
	EXPECT_EQ(*string_variable.entries().at(0).string(), "test");
	ASSERT_EQ(
	    string_variable.entries().at(1).type(), Value::Entry::Type::Value);
	ASSERT_EQ(string_variable.entries().at(1).value()->entries().size(), 1);
	ASSERT_EQ(
	    string_variable.entries().at(1).value()->entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(
	    *string_variable.entries().at(1).value()->entries().at(0).string(),
	    "VARIABLE");

	Value string_empty_variable = string + empty + variable;
	ASSERT_EQ(string_empty_variable.entries().size(), 2);
	ASSERT_EQ(string_empty_variable.entries().at(0).type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*string_empty_variable.entries().at(0).string(), "test");
	ASSERT_EQ(string_empty_variable.entries().at(1).type(),
	    Value::Entry::Type::Value);
	ASSERT_EQ(
	    string_empty_variable.entries().at(1).value()->entries().size(), 1);
	ASSERT_EQ(string_empty_variable.entries()
		      .at(1)
		      .value()
		      ->entries()
		      .at(0)
		      .type(),
	    Value::Entry::Type::String);
	EXPECT_EQ(*string_empty_variable.entries()
		      .at(1)
		      .value()
		      ->entries()
		      .at(0)
	...
	ASSERT_EQ(
	    string_string.entries().at(0).type(), Value::Entry::Type::String);
