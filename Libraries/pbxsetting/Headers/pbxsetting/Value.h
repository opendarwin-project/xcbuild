...
class Value {
	...
	class Entry {
		...
		std::shared_ptr<Value> const &value() const { return _value; }
	};
	 ...
	 */
	std::vector<Entry> const &entries() const { return _entries; }
	 ...
	 */
	static Value Parse(std::string const &value);
	 ...
	 */
	static Value FromObject(plist::Object const *object);
};
