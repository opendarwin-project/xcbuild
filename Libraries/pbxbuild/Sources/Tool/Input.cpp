...
Tool::Input::Input(std::string const &path,
...
Tool::Input::Input(
    std::string const &path, pbxspec::PBX::FileType::shared_ptr const &fileType)
    : Input(path, fileType, nullptr, ext::nullopt, ext::nullopt, ext::nullopt,
