...
class Environment {
    ...
    public:
	Environment(Build::Environment const &buildEnvironment,
	...
	Build::Context const &buildContext() const { return _buildContext; }
    ...
    public:
	static pbxsetting::Level VariantLevel(std::string const &variant);
	static pbxsetting::Level ArchitectureLevel(std::string const &arch);
};
