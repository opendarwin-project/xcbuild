...
class Context {
	...
	std::map<std::pair<std::string, std::string>,
	    std::vector<Tool::Invocation>>
	    _variantArchitectureInvocations;
    ...
    public:
	Context(xcsdk::SDK::Target::shared_ptr const &sdk,
    ...
    public:
	SearchPaths const &searchPaths() const { return _searchPaths; }

    public:
	HeadermapInfo const &headermapInfo() const { return _headermapInfo; }
	ModuleMapInfo const &moduleMapInfo() const { return _moduleMapInfo; }
    ...
    public:
	HeadermapInfo &headermapInfo() { return _headermapInfo; }
	ModuleMapInfo &moduleMapInfo() { return _moduleMapInfo; }
	CompilationInfo &compilationInfo() { return _compilationInfo; }
	...
	variantArchitectureInvocations() const
	{
		return _variantArchitectureInvocations;
	}

    public:
	std::vector<Tool::Invocation> &invocations() { return _invocations; }
	std::map<std::pair<std::string, std::string>,
	    std::vector<Tool::Invocation>> &
