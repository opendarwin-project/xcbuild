...
class Input {
	...
	/*
	 * A disambiguation identifier for different files with the same base
	 * name within a target. This should be used for the output path along
	 * with the base name in order to avoid overwriting outputs.
	 */
    ...
    public:
	/*
	 * The localization this file is for. This is relevant for variant
	 * groups, which contain many versions of the same file for different
	 * lproj outputs.
	 */
	...
	/*
	 * An opaque identifier of a localization group. Individual
	 * localizations are found within a group.
	 */
