...
class SwiftModuleInfo {
    ...
    public:
	SwiftModuleInfo(std::string const &architecture,
	 ...
	 */
	std::string const &moduleName() const { return _moduleName; }

    public:
	/*
	 * The path to the Swift module.
	 */
	std::string const &modulePath() const { return _modulePath; }

	/*
	 * The path to the Swift documentation output.
	 */
	std::string const &docPath() const { return _docPath; }
	 ...
	 */
	bool installHeader() const { return _installHeader; }

    public:
	/*
	 * List of artifacts copied at time of CopySwiftModules call.
	 */
	std::vector<std::string> &copiedArtifacts() { return _copiedArtifacts; }
};
