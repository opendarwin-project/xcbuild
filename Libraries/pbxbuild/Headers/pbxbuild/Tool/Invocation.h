...
class Invocation {
	...
	class DependencyInfo {
	    ...
	    public:
		DependencyInfo(dependency::DependencyInfoFormat format,
	...
	class Executable {
	    ...
	    private:
		Executable(ext::optional<std::string> const &external,
		 ...
		 */
		static Executable External(std::string const &path);

		/*
		 * Creates an executable for a known built-in tool.
		 */
		static Executable Builtin(std::string const &name);

		/*
		 * Creates an executable from an unknown string. The executable
		 * could be a builtin tool (starts with "builtin-") or an
		 * external tool path.
		 */
		static ext::optional<Executable> Determine(
    ...
    public:
	ext::optional<Executable> &executable() { return _executable; }
    ...
    public:
	std::vector<std::string> &phonyInputs() { return _phonyInputs; }
	...
	bool showEnvironmentInLog() const { return _showEnvironmentInLog; }

    public:
	std::string &logMessage() { return _logMessage; }
	bool &showEnvironmentInLog() { return _showEnvironmentInLog; }
    ...
    public:
	bool &createsProductStructure() { return _createsProductStructure; }

    public:
	bool waitForSwiftArtifacts() const { return _waitForSwiftArtifacts; }

    public:
	bool &waitForSwiftArtifacts() { return _waitForSwiftArtifacts; }
